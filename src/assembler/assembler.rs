...
mod tests {
    ...
    #[test]
    fn test_assemble() {
        let instructions = get_all_instructions("./instructions".to_string());
...
\n\
        ...
        assert_eq!(assembled, vec![0, 2, 0, 5, 67, 79, 68, 69, 250, 0, 0, 0, 0, 251, 68, 65, 84, 65, 250, 0, 0, 0, 44, 251, 109, 97, 105, 110, 250, 67, 79, 68, 69, 58, 48, 251, 108, 111, 111, 112, 250, 67, 79, 68, 69, 58, 50, 48, 251, 101, 110, 100, 250, 67, 79, 68, 69, 58, 52, 48, 251, 109, 115, 103, 250, 68, 65, 84, 65, 58, 48, 251, 109, 115, 103, 95, 101, 110, 100, 250, 68, 65, 84, 65, 58, 49, 51, 251, 0, 2, 0, 0, 0, 0, 0, 0, 0, 8, 97, 128, 0, 0, 64, 68, 65, 84, 65, 255, 80, 0, 0, 0, 97, 132, 0, 0, 64, 68, 65, 84, 65, 255, 80, 4, 0, 13, 81, 4, 0, 1, 88, 8, 0, 0, 80, 0, 0, 1, 89, 8, 0, 0, 96, 128, 96, 0, 81, 140, 32, 0, 125, 0, 0, 0, 72, 101, 108, 108, 111, 44, 32, 119, 111, 114, 108, 100, 33, 101]);
    }
}